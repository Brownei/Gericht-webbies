      ...
      <div className='container mx-auto px-10 py-4 z-20 flex justify-between items-center bg-black/95 shadow-xl text-white'>
        ...
        <div className='flex lg:hidden'>
          {toggleMenu 
            ...
            : (
              <div className='fixed top-0 right-0 flex flex-col h-screen w-[50vh] text-[14px] leading-[28px] bg-[#0C0C0C] z-20 text-white shadow-2xl'>
                ...
                <div className='flex flex-col space-y-7 items-center mt-24'>
                  <Link className='font-medium hover:scale-105 hover:text-lightBrown hover:font-bold focus:text-lightBrown focus:font-semibold focus:scale-105' to='/'> Home</Link>
                  <Link className='font-medium hover:scale-105 hover:text-lightBrown hover:font-bold focus:text-lightBrown focus:font-semibold focus:scale-105' to='/explore'> Explore</Link>
                  <Link className='font-medium hover:scale-105 hover:text-lightBrown hover:font-bold focus:text-lightBrown focus:font-semibold focus:scale-105' to='/contact-us'> Contact</Link>
                  <Link className='font-medium hover:scale-105 hover:text-lightBrown hover:font-bold focus:text-lightBrown focus:font-semibold focus:scale-105' to='/landing'> Landing</Link>
                  <Link className='font-medium hover:scale-105 hover:text-lightBrown hover:font-bold focus:text-lightBrown focus:font-semibold focus:scale-105' to='/sign-in'> Log in</Link>
                  <Link className='font-medium hover:scale-105 hover:text-lightBrown hover:font-bold focus:text-lightBrown focus:font-semibold focus:scale-105' to='/sign-up'> Registration</Link>
                  <Link className='font-medium hover:scale-105 hover:text-lightBrown hover:font-bold focus:text-lightBrown focus:font-semibold focus:scale-105' to='/book-table'> Book Table</Link>
                </div>
              </div>
            )
          }
          {toggleMenu 
            ? ''
            : ( <div className='w-screen h-screen fixed top-0 left-0 bg-black/70'/>)
          }
        </div>
      </div>
    </nav>
