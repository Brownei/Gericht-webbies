  ...
  return (
    <section className='container mx-auto p-6 w-fit bg-[#0C0C0C]'>
        <div className='flex flex-col space-y-1 justify-center items-center px-6 py-3 lg:py-6 lg:px-[100px]'>
            <p className='font-san font-bold leading-[29.9px] lg:text-[19px]'>Newsletter</p>
            <img className='w-[30px]' src="/Vector2.png" alt="spoon" />
            <h3 className=' font-semibold text-[1.5rem] leading-[83.2px] mt-[5px] mb-[10px] text-lightBrown md:text-[2rem] lg:text-[3rem] lg:leading-[117px]'>Subscribe To Our Newsletter</h3>
